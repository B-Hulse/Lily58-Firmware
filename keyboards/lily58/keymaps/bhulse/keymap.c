 ...
 */
 ...
 [_WORKMAN] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_M,    KC_C,    KC_V,       KC_DEL, KC_BSLS, KC_K,       KC_L,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,       KC_DEL, KC_BSLS, KC_N,       KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC, KC_RSFT, MO(_RAISE), KC_BSPC, KC_APP
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
