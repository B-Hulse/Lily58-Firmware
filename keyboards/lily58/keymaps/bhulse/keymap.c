 ...
 */
 ...
 [_WORKMAN] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_M,    KC_C,    KC_V,       KC_DEL, KC_BSLS, KC_K,       KC_L,    KC_COMM, KC_DOT,  KC_SLSH,  KC_F24,
                             KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC, KC_RSFT, MO(_RAISE), KC_BSPC, KC_APP
),  
/* QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  `   |
 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,       KC_DEL, KC_BSLS, KC_N,       KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_F24,
                             KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC, KC_RSFT, MO(_RAISE), KC_BSPC, KC_APP
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
  ...
  KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,   _______, _______,  _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_NUM,  KC_SCRL,
...
const uint16_t PROGMEM combo_enter[] = {KC_SPC, KC_RSFT, COMBO_END};
