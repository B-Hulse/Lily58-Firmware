...
[_LOWER] = LAYOUT(
  ...
  _______, UC_EXLM,  UC_GBP,  UC_DLR, UC_HASH, _______,                   _______, _______, _______, _______, _______, _______,
  _______, UC_PLUS, UC_DASH, UC_SCLN,  UC_EQL, _______,                   _______, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, _______,
  _______, UC_PERC, UC_CIRM, UC_ASTR, UC_AMPR, _______, _______, _______, _______, KC_LBRC, KC_RBRC,   KC_LT,   KC_GT, _______,
